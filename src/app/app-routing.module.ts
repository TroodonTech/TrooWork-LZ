...
import {UserDashboardsModule} from './control-and-view/dashboard/user-dashboards/user-dashboards.module';
...
const routes: Routes = [
  {
    path: '',
    loadChildren: './control-and-view/dashboard/login/login.module#LoginModule'
  },
  {
    path: 'welcomePage',
    loadChildren: './control-and-view/dashboard/user-welcome-pages/welcomepage/welcomepage.module#WelcomepageModule'
  },
  {
    path: 'Buildview',
    loadChildren: './control-and-view/manager/inventory/building-view/building-view.module#BuildingViewModule'
  },
  // {
  //   path: 'Createbuilding',
